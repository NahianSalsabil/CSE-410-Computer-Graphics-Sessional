...
void capture() {
    ...
    */
    ...
    bitmapImage.save_image("D:\\Academic 4-1\\CSE410 (Computer Graphics sessional)\\offline-3\\offline3-src\\outputs\\output"+currentBitmapImageCount.str()+".bmp");
